...
if ( ! defined("ACCESS_ROLE_ADMIN")) {  // can do all
    define("ACCESS_ROLE_ADMIN", 1);  // Admin
}
if ( ! defined("ACCESS_ROLE_ADMIN_LABEL")) {
    define("ACCESS_ROLE_ADMIN_LABEL", 'Admin');
}
...
if ( ! defined("ACCESS_ROLE_MANAGER")) {  // Manager - can  edit hostels
    define("ACCESS_ROLE_MANAGER", 2);
}
if ( ! defined("ACCESS_ROLE_MANAGER_LABEL")) {
    define("ACCESS_ROLE_MANAGER_LABEL", 'Manager');
}
...
if ( ! defined("ACCESS_ROLE_CUSTOMER")) {  // Customer - only personal part
    define("ACCESS_ROLE_CUSTOMER", 3);
}
if ( ! defined("ACCESS_ROLE_CUSTOMER_LABEL")) {
    define("ACCESS_ROLE_CUSTOMER_LABEL", 'Customer');
}
if ( ! defined("PERMISSION_CUSTOMER")) {
    define("PERMISSION_CUSTOMER", 'Customer functionality');
}
